...
class library_db_init():
    ...
    def create_db_tables(self):
        ...
        sql_drop_members_table = """DROP TABLE IF EXISTS members;"""
        sql_drop_books_table = """DROP TABLE IF EXISTS books;"""
        sql_drop_borrowing_table = """DROP TABLE IF EXISTS borrowing;"""
        ...
        try:
          ...
          cur.execute(sql_drop_books_table)
          cur.execute(sql_drop_members_table)
          cur.execute(sql_drop_borrowing_table)
